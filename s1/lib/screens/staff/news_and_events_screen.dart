                  ...
                  onChanged: (String? newValue) {
                    if (newValue != null) {
                      setState(() {
                        if (_sortBy == newValue) {
                          _sortDescending =
                              !_sortDescending; // Toggle direction
                        } else {
                          _sortBy = newValue;
                          ...
                          if (_sortBy == 'Priority') {
                            ...
                            _sortDescending =
                                true; // Newest/Largest first for dates/titles(Z-A)
                          }
                        }
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            if (item.miniNote != null &&
                                item.miniNote!.isNotEmpty) ...[
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color: AppColors.textColorDark.withOpacity(
                                    0.7,
                                  ),
                                ),
                              ),
