...
class LoanService {
  final CollectionReference<LoanModel> _loansCollection = FirebaseFirestore
      .instance
      .collection('loans')
  ...
  Future<DocumentReference<LoanModel>> createLoan(LoanModel loan) async {
    ...
    if (activeLoan != null) {
      throw Exception(
        'Book "${loan.bookTitle}" is already on loan to ${activeLoan.userName}.',
      );
    }
