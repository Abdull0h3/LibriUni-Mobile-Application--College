    ...
    final newsItems = <Map<String, dynamic>>[
      {
        ...
        'data': {
          ...
          'description':
              'Online services will be briefly unavailable for an urgent security patch.',
          ...
          'postedDate': Timestamp.fromDate(
            DateTime(2025, 5, 30, 10, 0, 0),
          ), // Example: May 30, 2025, 10:00 AM
        },
      },
      {
        'id': 'NEWS002',
        'data': {
          ...
          'description':
              'Join us for an evening with bestselling author Jane Doe, discussing her new novel.',
          'miniNote': 'Book signing to follow!',
          'fullDetails':
              "We are thrilled to host an exclusive meet and greet event with renowned author Jane Doe. She will be discussing her latest chart-topping novel, 'The Whispering Pages,' sharing insights into her writing process, and answering audience questions. The event will conclude with a book signing session. Copies of her books will be available for purchase. Don't miss this exciting opportunity!",
          'priority': 'medium',
          'type': 'information',
          'eventDate': Timestamp.fromDate(
            DateTime(2025, 6, 15, 19, 0, 0),
          ), // Example: June 15, 2025, 7:00 PM
          'postedDate': Timestamp.fromDate(
            DateTime(2025, 5, 28, 14, 30, 0),
          ), // Example: May 28, 2025, 2:30 PM
        },
      },
      {
        'id': 'NEWS003',
        'data': {
          ...
          'description':
              'Wi-Fi and public computers will have intermittent connectivity next Monday morning.',
          'miniNote': 'Plan accordingly.',
          'fullDetails':
              "Please be advised that scheduled network maintenance will be performed on Monday, June 2nd, from 8:00 AM to 12:00 PM. During this window, users may experience intermittent connectivity issues with the library's Wi-Fi network and public access computers. We recommend downloading any necessary materials beforehand. We appreciate your patience as we work to improve our network infrastructure.",
          'priority': 'low',
          'type': 'maintenance',
          'eventDate': Timestamp.fromDate(
            DateTime(2025, 6, 2, 8, 0, 0),
          ), // Example: June 2, 2025, 8:00 AM
          'postedDate': Timestamp.fromDate(
            DateTime(2025, 5, 29, 9, 0, 0),
          ), // Example: May 29, 2025, 9:00 AM
        },
      },
      {
        'id': 'NEWS004',
