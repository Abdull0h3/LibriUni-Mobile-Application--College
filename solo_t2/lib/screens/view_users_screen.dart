                ...
                : SingleChildScrollView(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        columns: const [
                          DataColumn(
                            label: Text('Name', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textColorDark)),
                          ),
                          DataColumn(
                            label: Text('User ID', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textColorDark)),
                          ),
                          DataColumn(
                            label: Text('Email', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textColorDark)),
                          ),
                          DataColumn(
                            label: Text('Overdue', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textColorDark)),
                          ),
                          DataColumn(
                            label: Text('Active', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textColorDark)),
                          ),
                        ],
                        rows: _filteredUsers.map((user) {
                          ...
                          return DataRow(cells: [
                            DataCell(Text(user.name, style: const TextStyle(color: AppColors.textColorDark))),
                            DataCell(Text(user.userIdString, style: const TextStyle(color: AppColors.textColorDark))),
                            DataCell(
                              ConstrainedBox(
