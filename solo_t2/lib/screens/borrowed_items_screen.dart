...
class _BorrowedItemsScreenState extends State<BorrowedItemsScreen> {
  ...
  List<BorrowedItemModel> _applySearch(
      List<BorrowedItemModel> items, String query) {
  ...
  void _performSearch() {
    setState(() {
      _filteredBorrowedItems =
          _applySearch(_allBorrowedItems, _searchController.text);
    });
  }
                ...
                : SingleChildScrollView(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        rows: _filteredBorrowedItems.map((item) {
